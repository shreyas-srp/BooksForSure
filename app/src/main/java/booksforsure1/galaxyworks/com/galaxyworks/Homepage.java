...
public class Homepage extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            String url = "https://play.google.com/store/apps/details?id=booksforsure1.galaxyworks.com.galaxyworks&hl=en";
